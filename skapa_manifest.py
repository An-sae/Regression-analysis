...
SV = {
    ...
    'validated {d}': 'validerad {d}',
    'Could not read file': 'Kunde inte läsa filen',
    # --- v2.2: brett format, översikt ---
    'Layout of file A': 'Filformat, fil A',
    'Layout of file B': 'Filformat, fil B',
    'Long: one row per result': 'Långt: en rad per resultat',
    'Wide: one column per analysis': 'Brett: en kolumn per analys',
    'Conversion factor for file B': 'Omräkningsfaktor för fil B',
    'Multiplies every result in file B, e.g. 0.1 to convert g/L to g/dL. 1 = no conversion.': 'Multiplicerar varje resultat i fil B, t.ex. 0,1 för att räkna om g/L till g/dL. 1 = ingen omräkning.',
    'Result columns: {n} selected': 'Resultatkolumner: {n} valda',
    'One column per analysis': 'En kolumn per analys',
    'Choose at least one result column in file {f}.': 'Välj minst en resultatkolumn i fil {f}.',
    ...
    'Not used': 'Används ej',
    'Slope 95% CI': 'Lutning 95 % KI',
    'Intercept 95% CI': 'Intercept 95 % KI',
    'Mean bias (%)': 'Medelbias (%)',
    'Slope CI includes 1': 'KI för lutning omfattar 1',
    'Intercept CI includes 0': 'KI för intercept omfattar 0',
    'Note': 'Anmärkning',
    'yes': 'ja',
    'no': 'nej',
    'too few pairs': 'för få par',
